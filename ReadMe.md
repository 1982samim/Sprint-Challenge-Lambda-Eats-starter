...
useRouteMatch accesses the object without the need to render the route.

2. How would you explain form validation to someone who has never programmed before?
Form validation is when the website checks that what you entered into the fields is in the correct format and respond to the constraints the website expects. 
Form validation can either be achieved by your web browser, this is called client-side validation. Or it can be done by  the server you get the website data from, this is called server-side validation.
